defmodule SymphonyElixir.AgentRunner do
  @moduledoc """
  Executes a single tracker work item in its workspace with the resolved
  coding-agent backend (Codex or Claude; see `SymphonyElixir.AgentBackend`).
  """
  ...
  defp run_codex_turns(workspace, issue, codex_update_recipient, opts, worker_host) do
    ...
    backend = Keyword.get(opts, :backend) || AgentBackend.resolve(issue)
